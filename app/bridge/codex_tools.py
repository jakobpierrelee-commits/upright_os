...
class CodexToolExecutor:
    ...
    def _tool_edit_sketch_value(self, args: Dict[str, Any]) -> ToolResult:
        """Edit sketch constant. Delegates to FirmwareTools."""
        return self._firmware_tools.edit_sketch_value(args)

    def _tool_read_sketch(self, args: Dict[str, Any]) -> ToolResult:
        """Read sketch source. Delegates to FirmwareTools."""
        return self._firmware_tools.read_sketch(args)
