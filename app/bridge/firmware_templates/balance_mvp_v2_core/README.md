...
Purpose: stripped tuning-first Nano sketch with deterministic balance loop, gain scheduling, full EEPROM persistence for iterative tuning variables, and current fault latch behavior.
...
- Non-essential command surfaces not needed for iterative balancing on Nano

Compile:
- `arduino-cli compile --clean --fqbn arduino:avr:nano app/bridge/firmware_templates/balance_mvp_v2_core`
