...
static void printHelp() {
  Serial.println(F("OK HELP GET ARM DISARM ESTOP PID SETPOINT LIMITS FILTER KAL CAL ZERO SAVECFG LOADCFG DEFAULTCFG FAULTCLR LOGT LOGCSV BURSTCSV CSVHDR IDENT MOTOR_TEST PREARM_CHECK"));
